...
bool test_is_head() {
  // TODO: Implement this function.
  //
if (!assert_true("is_head('W')", is_tail('W'))) return false;
if (!assert_true("is_head('A')", is_tail('A'))) return false;
if (!assert_true("is_head('S')", is_tail('S'))) return false;
if (!assert_true("is_head('D')", is_tail('D'))) return false;
if (!assert_true("is_head('x')", is_tail('x'))) return false;
if (!assert_false("is_head('w')", is_tail('w'))) return false;
...
bool test_is_snake() {
  // TODO: Implement this function.
if (!assert_true("is_snake('w')", is_tail('w'))) return false;
if (!assert_true("is_snake('^')", is_tail('^'))) return false;
if (!assert_true("is_snake('>')", is_tail('>'))) return false;
if (!assert_true("is_snake('W')", is_tail('W'))) return false;
if (!assert_true("is_snake('x')", is_tail('x'))) return false;
if (!assert_false("is_snake('z')", is_tail('z'))) return false;
